      ...
      <div className="max-w-5xl mx-auto bg-foreground rounded-[40px] p-8 md:p-20 text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto mb-12">
            Join the elite teams using Qaos to automate their entire quality assurance pipeline with
            intent-based AI.
          </p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <Link href="/signup" className="w-full md:w-auto">
              <Button
                size="lg"
                className="w-full md:w-auto px-10 bg-white text-foreground hover:bg-gray-100"
              >
            ...
            <Button
              variant="ghost"
              size="lg"
              className="w-full md:w-auto px-10 text-white border border-gray-700 hover:bg-white/5"
            >
              Talk to Sales
            </Button>
          </div>
