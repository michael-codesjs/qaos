  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all duration-300 outline-none focus:ring-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-gray-200 bg-transparent hover:bg-gray-50 hover:border-gray-300 text-foreground",
        navigator: "bg-navigator text-white hover:opacity-90 shadow-[0_4px_14px_rgba(225,101,64,0.3)]",
        strategist: "bg-strategist text-white hover:opacity-90 shadow-[0_4px_14px_rgba(50,142,250,0.3)]",
      },
      size: {
